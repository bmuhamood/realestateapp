        ...
        <div style={{ textAlign: 'center', marginBottom: 32 }}>
          <div style={{ display: 'inline-flex', alignItems: 'center', gap: 8, marginBottom: 12 }}>
            ...
            <div style={{ textAlign: 'left' }}>
              <div style={{ fontSize: 18, fontWeight: 800, color: NAVY, fontFamily: "'Sora', sans-serif" }}>Metro Care</div>
          ...
          <p style={{ fontSize: 14, color: SLATE, margin: 0 }}>Join METRO CARE PROPERTIES's fastest growing property platform</p>
        </div>
